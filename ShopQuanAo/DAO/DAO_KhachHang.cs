...
namespace ShopQuanAo
{
    public class DAO_KhachHang:QuanLyKetNoi
    {
        public void GhiThongTinKhachHang(KhachHang kh)
        {
            ...
            dao.Open();
            string qry = "insert into khachhang(TenDangNhap,MatKhau,HoTen,GioiTinh,DiaChi,Email,SoDienThoai,LaAdmin) values('" + kh.TENDANGNHAP + "','" + kh.MATKHAU + "', N'" + kh.HOTEN + "'," + kh.GIOITINH + ", N'" + kh.DIACHI + "','" + kh.EMAIL + "','" + kh.SODIENTHOAI + "','False')";
